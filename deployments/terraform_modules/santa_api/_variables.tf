...
variable "disable_execute_api_endpoint" {
  type = bool
  description = "Whether or not to disable the default execute-api endpoint generated by API Gateway. To allow clients to access your API only by using a custom domain name, disable the default endpoint."
  default = true
}
